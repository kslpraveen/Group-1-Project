...
public class Chart extends ApplicationFrame{
	...
	static int dup;
	static String title;
public Chart(String paramString,long time,int d){
	super(paramString);
	runtime = time;
	dup = d;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(runtime,"Runtime","Runtime");
	localDefaultCategoryDataset.addValue(dup,"Detection Count","Detection Count");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Time & Duplicate", "Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
