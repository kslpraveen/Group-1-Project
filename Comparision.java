...
public class Comparision extends ApplicationFrame{
	static long propose;
	static long existing;
	static String title;
public Comparision(String paramString,long p,long e){
	super(paramString);
	propose = p;
	existing = e;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(propose,"Parallel","Parallel");
	localDefaultCategoryDataset.addValue(existing,"Normal","Normal");
